...
//    void removeStatement(int lineNumber);
 ...
 */
    ...
    void findLineNumber(int line_number);
...
// Fill this in with whatever types and instance variables you need
    ...
    unordered_map<int, string> program_lines;
    unordered_map<int, Statement *> program_parsed;
    set<int>::iterator it;
    bool end = false;
};
